                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td align="center" valign="top" style="padding: 40px 30px 20px 30px; font-size: 20px;"> 
                            <img src="{{URL::asset('images/logo.png')}}" alt="{{config('app.name')}}" width="150px"></a>
						</td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td align="center" style="padding: 0px 10px 0px 10px;">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left" style="border-top: 1px solid #ed4b0c; padding: 10px 30px 40px 30px; border-radius: 0px 0px 4px 4px; color: #000; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
