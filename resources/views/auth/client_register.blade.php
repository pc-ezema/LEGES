...
<head>
    ...
    <title>{{config('app.name')}} - Client Registration</title>
                    ...
                    <div class="bg-white rounded10 shadow-lg">
                        ...
                        <div class="p-40">
                            <form method="POST" action="{{ route('register') }}" id="registerForm" enctype="multipart/form-data">
                                @csrf
                                <input name="account_type" value="Client" hidden>
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text bg-transparent"><i class="ti-user"></i></span>
                                                <select name="gender" id="gender" class="form-control ps-15 bg-transparent @error('gender') is-invalid @enderror" value="{{ old('gender') }}" required autofocus>
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text bg-transparent"><i class="ti-user"></i></span>
                                                <input id="phone_number" placeholder="Phone Number" class="form-control ps-15 bg-transparent @error('phone_number') is-invalid @enderror" type="tel" name="phone_number" required value="{{ old('phone_number') }}" autofocus>
                                                @error('phone_number')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
