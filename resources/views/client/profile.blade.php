        ...
        <section class="content">
            <div class="row">			  
                <div class="col-lg-6 col-12">
                    <div class="box">
                    <!-- /.box-header -->
                    <form class="form" method="POST" action="{{ route('client.profile-picture', Crypt::encrypt(Auth::user()->id)) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="box-body">
                ...
                <div class="col-lg-6 col-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <hr class="my-15">
                            <form class="form" method="POST" action="{{ route('client.personal-data', Crypt::encrypt(Auth::user()->id)) }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <hr class="my-15">
                            <form class="form" method="POST" action="{{ route('client.password', Crypt::encrypt(Auth::user()->id)) }}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
