            ...
            <div class="col-lg-5">
                <a href="#">
                    <div class="box" style="background-color: #ED4B0C">
                        ...
                        <a class="btn-leges mt-4 mb-3" href="#" style="background-color: #fff; display: inline-block; color: #000;
                ...
                <div class="col-md-12 text-center">
                    <p class="already">I already have an account! <a href="#" class="btn-login" style="color: #fff;">Login</a></p>
                </div>
            </div>
            <div class="col-lg-5">
                <a href="#">
                    <div class="box">
                        <h4>Lawyer</h4>
                        <a class="btn-leges mt-4 mb-3" href="#" style="background-color: #ED4B0C; display: inline-block; color: #fff;
